...
// @ts-ignore
import { ProductsWithIdRequestBuilderRequestsMetadata, type ProductsWithIdRequestBuilder } from './productsWithId/index.js';
// @ts-ignore
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    productsWithId: {
        requestsMetadata: ProductsWithIdRequestBuilderRequestsMetadata,
    },
    products: {
